...
MEDIA_BY_ID             = '/graphql/query/?query_id=17888483320059182&variables={"id": "%s","first":20,"after":%s}'
MEDIA_BY_LOCATION       = '/explore/locations/%s/%s/?__a=1'
COMMENT_BY_SHORTCODE    = '/graphql/query/?query_hash=33ba35852cb50da46f5b5e889df7d159&variables={"shortcode":"%s", "first":20,"after":"%s"}'
